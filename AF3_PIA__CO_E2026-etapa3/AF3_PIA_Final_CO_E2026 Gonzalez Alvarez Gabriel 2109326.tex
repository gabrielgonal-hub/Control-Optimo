...
El problema de optimización se resolvió mediante la solución de la ecuación algebraica de Riccati en Python. El código completo se presenta en el Apéndice \ref{sec:SolveLQR}. A continuación se muestran las líneas relevantes correspondientes al cálculo de la solución de Riccati y la ganancia LQR:
